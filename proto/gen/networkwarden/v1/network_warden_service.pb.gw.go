...
func request_NetworkWardenService_CheckEmails_0(ctx context.Context, marshaler runtime.Marshaler, client NetworkWardenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.CheckEmails(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func local_request_NetworkWardenService_CheckEmails_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkWardenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.CheckEmails(ctx, &protoReq)
	return msg, metadata, err
...
func request_NetworkWardenService_CheckPhoneNumbers_0(ctx context.Context, marshaler runtime.Marshaler, client NetworkWardenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.CheckPhoneNumbers(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func local_request_NetworkWardenService_CheckPhoneNumbers_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkWardenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.CheckPhoneNumbers(ctx, &protoReq)
	return msg, metadata, err
...
func request_NetworkWardenService_InitiatePersonalDataNode_0(ctx context.Context, marshaler runtime.Marshaler, client NetworkWardenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.InitiatePersonalDataNode(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func local_request_NetworkWardenService_InitiatePersonalDataNode_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkWardenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.InitiatePersonalDataNode(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterNetworkWardenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NetworkWardenServiceServer) error {
	...
	mux.Handle("POST", pattern_NetworkWardenService_CheckEmails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/networkwarden.v1.NetworkWardenService/CheckEmails", runtime.WithHTTPPathPattern("/networkwarden.v1.NetworkWardenService/CheckEmails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_NetworkWardenService_CheckEmails_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_NetworkWardenService_CheckEmails_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_NetworkWardenService_CheckPhoneNumbers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/networkwarden.v1.NetworkWardenService/CheckPhoneNumbers", runtime.WithHTTPPathPattern("/networkwarden.v1.NetworkWardenService/CheckPhoneNumbers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_NetworkWardenService_CheckPhoneNumbers_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_NetworkWardenService_CheckPhoneNumbers_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_NetworkWardenService_InitiatePersonalDataNode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/networkwarden.v1.NetworkWardenService/InitiatePersonalDataNode", runtime.WithHTTPPathPattern("/networkwarden.v1.NetworkWardenService/InitiatePersonalDataNode"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_NetworkWardenService_InitiatePersonalDataNode_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_NetworkWardenService_InitiatePersonalDataNode_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterNetworkWardenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NetworkWardenServiceClient) error {
	...
	mux.Handle("POST", pattern_NetworkWardenService_CheckEmails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/networkwarden.v1.NetworkWardenService/CheckEmails", runtime.WithHTTPPathPattern("/networkwarden.v1.NetworkWardenService/CheckEmails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_NetworkWardenService_CheckEmails_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_NetworkWardenService_CheckPhoneNumbers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/networkwarden.v1.NetworkWardenService/CheckPhoneNumbers", runtime.WithHTTPPathPattern("/networkwarden.v1.NetworkWardenService/CheckPhoneNumbers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_NetworkWardenService_CheckPhoneNumbers_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_NetworkWardenService_InitiatePersonalDataNode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/networkwarden.v1.NetworkWardenService/InitiatePersonalDataNode", runtime.WithHTTPPathPattern("/networkwarden.v1.NetworkWardenService/InitiatePersonalDataNode"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_NetworkWardenService_InitiatePersonalDataNode_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_NetworkWardenService_CheckEmails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"networkwarden.v1.NetworkWardenService", "CheckEmails"}, ""))

	pattern_NetworkWardenService_CheckPhoneNumbers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"networkwarden.v1.NetworkWardenService", "CheckPhoneNumbers"}, ""))
	...
	pattern_NetworkWardenService_InitiatePersonalDataNode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"networkwarden.v1.NetworkWardenService", "InitiatePersonalDataNode"}, ""))
...
var (
	forward_NetworkWardenService_CheckEmails_0 = runtime.ForwardResponseMessage

	forward_NetworkWardenService_CheckPhoneNumbers_0 = runtime.ForwardResponseMessage
	...
	forward_NetworkWardenService_InitiatePersonalDataNode_0 = runtime.ForwardResponseMessage
