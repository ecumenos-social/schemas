...
func (m *Channel) validate(all bool) error {
	...
	// no validation rules for HeaderImageUrl
	...
	if m.NameLanguage != nil {
		// no validation rules for NameLanguage
	}

	if m.DescriptionLanguage != nil {
		// no validation rules for DescriptionLanguage
	}
