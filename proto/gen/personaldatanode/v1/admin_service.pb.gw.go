...
func RegisterAdminServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AdminServiceServer) error {
	...
	mux.Handle("POST", pattern_AdminService_LoginAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/personaldatanode.v1.AdminService/LoginAdmin", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/LoginAdmin"))
		if err != nil {
	...
	mux.Handle("POST", pattern_AdminService_RefreshAdminToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/personaldatanode.v1.AdminService/RefreshAdminToken", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/RefreshAdminToken"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AdminService_LogoutAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/personaldatanode.v1.AdminService/LogoutAdmin", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/LogoutAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AdminService_ChangeAdminPassword_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/personaldatanode.v1.AdminService/ChangeAdminPassword", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/ChangeAdminPassword"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterAdminServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AdminServiceClient) error {
	...
	mux.Handle("POST", pattern_AdminService_LoginAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/personaldatanode.v1.AdminService/LoginAdmin", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/LoginAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AdminService_RefreshAdminToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/personaldatanode.v1.AdminService/RefreshAdminToken", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/RefreshAdminToken"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AdminService_LogoutAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/personaldatanode.v1.AdminService/LogoutAdmin", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/LogoutAdmin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AdminService_ChangeAdminPassword_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/personaldatanode.v1.AdminService/ChangeAdminPassword", runtime.WithHTTPPathPattern("/personaldatanode.v1.AdminService/ChangeAdminPassword"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_AdminService_LoginAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"personaldatanode.v1.AdminService", "LoginAdmin"}, ""))

	pattern_AdminService_RefreshAdminToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"personaldatanode.v1.AdminService", "RefreshAdminToken"}, ""))

	pattern_AdminService_LogoutAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"personaldatanode.v1.AdminService", "LogoutAdmin"}, ""))

	pattern_AdminService_ChangeAdminPassword_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"personaldatanode.v1.AdminService", "ChangeAdminPassword"}, ""))
)
